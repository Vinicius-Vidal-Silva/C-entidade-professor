...
void definir_avaliacoes(){
	...
	if(!file){
		//se o arquivo não existir, entra na condicionar
		//e cria o arquivo
...
int main(){
	...
	do{
		...
		//ao achar, retorna o indice da 1ª ocorrência
		...
		//a função retorna 3 possibilidade
		//0 se forem iguais
		...
		//função atoi() converte uma string em um inteiro
